...
export const TestsApiFp = function(configuration?: Configuration) {
    ...
    return {
        ...
        async apiTestGet(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>> {
            ...
            const localVarOperationServerBasePath = operationServerMap['TestsApi.apiTestGet']?.[localVarOperationServerIndex]?.url;
...
export class TestsApi extends BaseAPI {
    ...
    public apiTestGet(options?: RawAxiosRequestConfig) {
        return TestsApiFp(this.configuration).apiTestGet(options).then((request) => request(this.axios, this.basePath));
    }
}
